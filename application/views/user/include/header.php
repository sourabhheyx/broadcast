...
<head>
  ...
  <title><?php if(!empty($title)) { echo $title; } else { echo 'Admin | Dashboard '; }?> </title>
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assest/admin/plugins/iCheck/all.css">
  <!-- Bootstrap Color Picker -->
  <link rel="stylesheet" href="<?php echo base_url();?>assest/admin/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
  <!-- Bootstrap time Picker -->
  <link rel="stylesheet" href="<?php echo base_url();?>assest/admin/plugins/timepicker/bootstrap-timepicker.min.css">
  <!-- Select2 -->
  <link rel="stylesheet" href="<?php echo base_url();?>assest/admin/bower_components/select2/dist/css/select2.min.css">
