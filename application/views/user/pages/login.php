...
<body class="hold-transition login-page" style = "background-image: url('assest/dist/img/image001.png');background-repeat: no-repeat;height: 20%; background-position: center;background-size: cover; ">
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url();?>"><b></b>Admin</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="" method="post">
      <div class="form-group has-feedback">
        <input class="form-control" placeholder="Enter Your Email Address" name="username" type="text" value="<?php if(isset($_COOKIE['junaid-hassan-alvi'] ['username'])){echo $_COOKIE['junaid-hassan-alvi'] ['username']; }else{ echo set_value('username');} ?>" autofocus> 
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
         <input class="form-control" placeholder="Password" name="password" type="password" value="<?php if(isset($_COOKIE['junaid-hassan-alvi'] ['password'])){echo $_COOKIE['junaid-hassan-alvi'] ['password']; }else{ echo set_value('password');
                    } ?>">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
               <?php if(isset($_COOKIE['junaid-hassan-alvi'] ['username']) && isset($_COOKIE['junaid-hassan-alvi'] ['password'])){ ?>
