            ...
            <form role="form" method = "post" enctype="multipart/form-data" action="">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="exampleInputEmail1"  readonly name= "email" placeholder="Enter email" value="<?php if(!empty($data['email'])){ echo $data['email']; }?>">
                  <?php echo form_error('email'); ?>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Mobile No.</label>
                  <input type="number" class="form-control" id="exampleInputEmail1" readonly name = "mobile" placeholder="Enter Mobile No." value="<?php if(!empty($data['mobile'])){ echo $data['mobile']; }?>">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="dsix_api_key" name = "dsix_api_key" placeholder="Enter Api Key" value="<?php if(!empty($data['dsix_api_key'])){ echo $data['dsix_api_key']; }?>">
                ...
                <div class="form-group">
                    <img src ="<?php echo base_url(); ?>uploads/users/<?php if(!empty($data['image'])){ echo $data['image']; }?>" height= "80px" width= "80px" >
                </div>  
