             ...
             <div class="col-md-3">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter Product Price" type="text" name="product_price" value="<?php if(!empty($update)) { echo $update['product_price']; } else { echo set_value('product_price'); } ?>">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter Product Sale" type="text" name="sale_price" value="<?php if(!empty($update)) { echo $update['sale_price']; } else { echo set_value('sale_price'); } ?>">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter Product Unit" type="text" name="product_qty" value="<?php if(!empty($update)) { echo $update['product_qty']; } else { echo set_value('product_qty'); } ?>">
               ...
               <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Red,Green,Yello,Blue" type="text" name="product_color" value="<?php if(!empty($update)) { echo $update['product_color']; } else { echo set_value('product_color'); } ?>">
               ...
               <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="S,M,L,XL,XXL" type="text" name="product_size" value="<?php if(!empty($update)) { echo $update['product_size']; } else { echo set_value('product_size'); } ?>">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter Product Image" type="file" name="image" >
                  <input class="form-control" placeholder="Enter Product Image" type="hidden" name="oldimage" value="<?php if(!empty($update)) { echo $update['image']; } else { echo set_value('image'); } ?>">
               ...
               <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter Product Image" type="file" name="image_two" >
                  <input class="form-control" placeholder="Enter Product Image" type="hidden" name="oldimage_two" value="<?php if(!empty($update)) { echo $update['backimage']; } else { echo set_value('backimage'); } ?>">
               ...
               <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" placeholder="Enter Product Desctiption"  name="product_description" > <?php if(!empty($update)) { echo $update['product_description']; } else { echo set_value('product_description'); } ?></textarea>
