               ...
               <?php if(!empty($data)){
                ...
                <tr>
                    ...
                    <!--  <td><?php if($value['status']==1){ ?>
                        <a href="<?php echo base_url() ?>admin/Web/active_About/<?php echo $value['id'] ?>" ><span class="label label-primary">Active</span></a>
                      <?php }else{ ?>
                        <a href="<?php echo base_url() ?>admin/Web/active_About/<?php echo $value['id'] ?>" ><span class="label  label-danger">Deactive</span></a>
                      <?php } ?></td>
                    
                      <td>
                    
                    <a onclick="return confirm('Are you sure you want to delete this About Us?');" href="<?php echo base_url() ?>admin/Web/aboutDelete/<?php echo $value['id'] ?>" title="DELETE" ><span class="label label-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></span></a>
