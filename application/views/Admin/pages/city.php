          ...
          <div class="box-body">
              <div class="col-md-4">
                <div class="form-group">
                  <label>Country</label>
                  <select name="country_id" onchange ="getstate(this.value);" class="form-control">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Enter City" type="text" name="city" value="<?php if(!empty($update)) { echo $update['city']; } else { echo set_value('city'); } ?>">
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php if(!empty($data)){
                ...
                <tr>
                      ...
                      <td>
                          <a href="<?php echo base_url() ?>admin/master/district/<?php echo $value['id'] ?>" title="EDIT" ><span class="label label-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span></a>
                          &nbsp;
                          <a onclick="return confirm('Are you sure you want to delete this district?');" href="<?php echo base_url() ?>admin/master/stateDelete/<?php echo $value['id'] ?>" title="DELETE" ><span class="label label-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></span></a>
