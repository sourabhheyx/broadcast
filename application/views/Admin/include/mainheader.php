 ...
 <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>admin-dashboard" class="logo">
     ...
     <a href="<?php echo base_url(); ?>user-dashboard" class="logo">        
      ...
      <span class="logo-lg"><?php if($type == 0){ echo 'ADMIN'; }else { ?><b></b>ADMIN <?php } ?></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url();?>admin/Dashboard/Profile" class="btn btn-default btn-flat">Profile</a>
                </div>
